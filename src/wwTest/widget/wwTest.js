...
define([
    ...
    "wwTest/lib/jquery-1.11.2",
    "dojo/text!wwTest/widget/template/wwTest.html"
    ...
    return declare("wwTest.widget.wwTest", [ _WidgetBase, _TemplatedMixin ], {
